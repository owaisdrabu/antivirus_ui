...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(10, 20, 691, 321));
        tabWidget->setFocusPolicy(Qt::TabFocus);
        tabWidget->setContextMenuPolicy(Qt::NoContextMenu);
        tabWidget->setAcceptDrops(false);
        tabWidget->setLayoutDirection(Qt::LeftToRight);
        tabWidget->setStyleSheet(QStringLiteral("background: transparent;"));
...
"background-color: rgb(171, 179, 229);"));
        scrollArea = new QScrollArea(tab);
        scrollArea->setObjectName(QStringLiteral("scrollArea"));
        scrollArea->setGeometry(QRect(80, 130, 571, 91));
        ...
        label_2->setGeometry(QRect(80, 20, 91, 21));
...
"background-color: rgb(171, 179, 229);"));
        ...
        pushButton_3->setGeometry(QRect(80, 50, 75, 23));
        pushButton_3->setStyleSheet(QLatin1String("background: transparent;\n"
"background-color: rgb(171, 179, 229);"));
        label_3 = new QLabel(tab_3);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(80, 20, 73, 21));
...
""));
        ...
        scrollArea_3->setGeometry(QRect(80, 130, 571, 91));
...
"background-color: rgb(171, 179, 229);"));
        ...
        scrollArea_4->setGeometry(QRect(80, 150, 571, 111));
        scrollArea_4->setStyleSheet(QStringLiteral("background: transparent;"));
        scrollArea_4->setWidgetResizable(true);
        scrollAreaWidgetContents_4 = new QWidget();
        scrollAreaWidgetContents_4->setObjectName(QStringLiteral("scrollAreaWidgetContents_4"));
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 569, 109));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MainWindow", "Full Scan", Q_NULLPTR));
        label_2->setText(QApplication::translate("MainWindow", "Quick Scan", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("MainWindow", "Run Quick Scan", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MainWindow", "Quick Scan", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("MainWindow", "Run Usb Scan", Q_NULLPTR));
        label_3->setText(QApplication::translate("MainWindow", "Usb Scan", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("MainWindow", "Usb Scan", Q_NULLPTR));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("MainWindow", "Selective Scan", Q_NULLPTR));
    } // retranslateUi
